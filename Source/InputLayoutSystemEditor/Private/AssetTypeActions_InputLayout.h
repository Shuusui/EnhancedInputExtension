...
public:
	...
	virtual uint32 GetCategories() override {	FInputLayoutSystemEditorModule::GetInputAssetCategories(); }
	...
	virtual UClass* GetSupportedClass() const override { return UInputLayout::StaticClass(); }
};